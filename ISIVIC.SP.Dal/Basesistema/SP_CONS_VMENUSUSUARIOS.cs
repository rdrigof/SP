...
{
	public class SP_CONS_VMENUSUSUARIOS
	{
		public SP_CONS_VMENUSUSUARIOS(){ }
			...
			public VmenususuariosResponse get_Vmenususuarios(Vmenususuarios vmenususuarios)
			{
				...
				NCH.Fwk.Bd.MySql.Coneccion = NCH.Fwk.Configuration.SettingsServices.MysqlConect;
					...
					cmd.CommandText = "SP_CONS_VMENUSUSUARIOS";
					...
					vmenususuariosResponse.ErrorCode = vmenususuariosResponse.Result.First().ErrorCode;
					vmenususuariosResponse.ErrorDescription = vmenususuariosResponse.Result.First().ErrorDescription;
					}
					catch (Exception ex)
					{
